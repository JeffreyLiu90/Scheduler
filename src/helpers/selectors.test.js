...
//state.appointments["3"] = interview: { student: "Archie Cohen", interviewer: 2 }
//.interview = state.interviewers[interview.interviewer]
//[interview.interviewer] in this case = 2, so
//This pulls out interviewers[2] - matching the ID
